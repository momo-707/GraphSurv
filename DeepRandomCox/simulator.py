...
class SimulatedData:
    ...
    #     -------
    #     dict
    #         data: a dictionary object with the following keys:
    ...
    #     return data
    def generate_data(self, N,
        method = 'gaussian', seed = 1, censor_rate=0.5, gaussian_config = {}, ##method = 'gaussian'
        **kwargs):
        """Generates a set of observations according to an exponentional Cox model.
        ...
        # censor_time = np.random.uniform(low= 0, high= 1,
        #     size = (N,1))
